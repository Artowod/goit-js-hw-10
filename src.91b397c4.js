...
"use strict";require("./css/styles.css");var e=l(require("lodash/debounce"));function l(e){return e&&e.__esModule?e:{default:e}}const s=300;let t=null;const o=(0,e.default)(()=>{t=setInterval(()=>{console.log("a")},500)},2e3);console.log("start"),o(),clearInterval(t);const n=setTimeout(()=>{clearInterval(t),console.log("end")},4e3);
},{"./css/styles.css":"krre","lodash/debounce":"CXfR"}]},{},["Focm"], null)
//# sourceMappingURL=/parcel-project-template/src.91b397c4.js.map